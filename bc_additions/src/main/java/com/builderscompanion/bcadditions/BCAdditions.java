package com.builderscompanion.bcadditions;

import com.builderscompanion.bcadditions.boprosequartz.BuddingRoseQuartzBlock;
...
public class BCAdditions {
    ...
    public static final String MODID = "bc_additions";
    ...
    public BCAdditions() {
        ...
        com.builderscompanion.bcadditions.enchantment.ModEnchantments.ENCHANTMENTS.register(modEventBus);
    ...
    private void commonSetup(final FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            com.builderscompanion.bcadditions.boprosequartz.BopRoseQuartz.resolveOrSkip();

            if (com.builderscompanion.bcadditions.boprosequartz.BopRoseQuartz.ready()) {
